var e = 1e3, t = 1001, n = 1002, r = 1003, i = 1006, a = 1008, o = 1009, s = 1012, c = 1014, l = 1015, u = 1016, d = 1017, f = 1018, p = 1020, m = 1023, h = 1026, g = 1027, _ = 1029, v = 1030, y = 1031, b = 1033, x = 2300, S = 2301, C = 2302, w = 2303, T = 2400, E = 2401, D = 2402, O = "srgb", k = "srgb-linear", A = "linear", j = "srgb", M = 7680, ee = 2e3;
function N(e) {
...
var U = class e {
	...
	*[Symbol.iterator]() {
	...
	applyEuler(e) {
		return this.applyQuaternion(he.setFromEuler(e));
	}
	applyAxisAngle(e, t) {
		return this.applyQuaternion(he.setFromAxisAngle(e, t));
	}
	applyMatrix3(e) {
	...
	*[Symbol.iterator]() {
...
}, me = /*@__PURE__*/ new W(), he = /*@__PURE__*/ new pe(), G = class e {
	static {
	...
	scale(e, t) {
		return ie("Matrix3: .scale() is deprecated. Use .makeScale() instead."), this.premultiply(ge.makeScale(e, t)), this;
	}
	rotate(e) {
		return ie("Matrix3: .rotate() is deprecated. Use .makeRotation() instead."), this.premultiply(ge.makeRotation(-e)), this;
	}
	translate(e, t) {
		return ie("Matrix3: .translate() is deprecated. Use .makeTranslation() instead."), this.premultiply(ge.makeTranslation(e, t)), this;
	}
	makeTranslation(e, t) {
...
}, ge = /*@__PURE__*/ new G(), _e = /*@__PURE__*/ new G().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), ve = /*@__PURE__*/ new G().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function ye() {
	let e = {
		enabled: !0,
		workingColorSpace: k,
		...
		convert: function(e, t, n) {
			return this.enabled === !1 || t === n || !t || !n ? e : (this.spaces[t].transfer === "srgb" && (e.r = be(e.r), e.g = be(e.g), e.b = be(e.b)), this.spaces[t].primaries !== this.spaces[n].primaries && (e.applyMatrix3(this.spaces[t].toXYZ), e.applyMatrix3(this.spaces[n].fromXYZ)), this.spaces[n].transfer === "srgb" && (e.r = xe(e.r), e.g = xe(e.g), e.b = xe(e.b)), e);
		},
		...
		fromWorkingColorSpace: function(t, n) {
			return ie("ColorManagement: .fromWorkingColorSpace() has been renamed to .workingToColorSpace()."), e.workingToColorSpace(t, n);
		},
		toWorkingColorSpace: function(t, n) {
			return ie("ColorManagement: .toWorkingColorSpace() has been renamed to .colorSpaceToWorking()."), e.colorSpaceToWorking(t, n);
		}
	}, t = [
		.64,
		.33,
...
var Se, Ce = class {
	static getDataURL(e, t = "image/png") {
		...
		if (e instanceof HTMLCanvasElement) n = e;
			...
			Se === void 0 && (Se = F("canvas")), Se.width = e.width, Se.height = e.height;
			let t = Se.getContext("2d");
			e instanceof ImageData ? t.putImageData(e, 0, 0) : t.drawImage(e, 0, 0, e.width, e.height), n = Se;
		}
	...
	constructor(e = null) {
		this.isTextureSource = !0, Object.defineProperty(this, "id", { value: we++ }), this.uuid = ce(), this.data = e, this.dataReady = !0, this.version = 0;
	}
	getSize(e) {
		let t = this.data;
	...
	toJSON(e) {
		...
		if (r !== null) {
			...
			if (Array.isArray(r)) {
				e = [];
				for (let t = 0, n = r.length; t < n; t++) r[t].isDataTexture ? e.push(Ee(r[t].image)) : e.push(Ee(r[t]));
			} else e = Ee(r);
			n.url = e;
		}
...
function Ee(e) {
	return typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap ? Ce.getDataURL(e) : e.data ? {
...
var Ae = class e {
	...
	*[Symbol.iterator]() {
	...
	constructor(e = 1, t = 1, n = {}) {
		...
		}, n), this.isRenderTarget = !0, this.width = e, this.height = t, this.depth = n.depth, this.scissor = new Ae(0, 0, e, t), this.scissorTest = !1, this.viewport = new Ae(0, 0, e, t), this.textures = [];
		let r = new ke({
			width: e,
			height: t,
			depth: n.depth
	...
	copy(e) {
		...
		for (let t = 0, n = e.textures.length; t < n; t++) {
			...
			this.textures[t].source = new Te(n);
		}
	...
	extractRotation(e) {
		...
		let t = this.elements, n = e.elements, r = 1 / Fe.setFromMatrixColumn(e, 0).length(), i = 1 / Fe.setFromMatrixColumn(e, 1).length(), a = 1 / Fe.setFromMatrixColumn(e, 2).length();
	...
	makeRotationFromQuaternion(e) {
		return this.compose(J, e, Le);
	}
	lookAt(e, t, n) {
		let r = this.elements;
		return Re.subVectors(e, t), Re.lengthSq() === 0 && (Re.z = 1), Re.normalize(), Y.crossVectors(n, Re), Y.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Re.x += 1e-4 : Re.z += 1e-4, Re.normalize(), Y.crossVectors(n, Re)), Y.normalize(), X.crossVectors(Re, Y), r[0] = Y.x, r[4] = X.x, r[8] = Re.x, r[1] = Y.y, r[5] = X.y, r[9] = Re.y, r[2] = Y.z, r[6] = X.z, r[10] = Re.z, this;
	}
	multiply(e) {
		return this.multiplyMatrices(this, e);
	}
	...
	decompose(e, t, n) {
		...
		let a = Fe.set(r[0], r[1], r[2]).length(), o = Fe.set(r[4], r[5], r[6]).length(), s = Fe.set(r[8], r[9], r[10]).length();
		i < 0 && (a = -a), Ie.copy(this);
		let c = 1 / a, l = 1 / o, u = 1 / s;
		return Ie.elements[0] *= c, Ie.elements[1] *= c, Ie.elements[2] *= c, Ie.elements[4] *= l, Ie.elements[5] *= l, Ie.elements[6] *= l, Ie.elements[8] *= u, Ie.elements[9] *= u, Ie.elements[10] *= u, t.setFromRotationMatrix(Ie), n.x = a, n.y = o, n.z = s, this;
	}
...
}, Fe = /*@__PURE__*/ new W(), Ie = /*@__PURE__*/ new Pe(), J = /*@__PURE__*/ new W(0, 0, 0), Le = /*@__PURE__*/ new W(1, 1, 1), Y = /*@__PURE__*/ new W(), X = /*@__PURE__*/ new W(), Re = /*@__PURE__*/ new W(), ze = /*@__PURE__*/ new Pe(), Be = /*@__PURE__*/ new pe(), Ve = class e {
	...
	reorder(e) {
		return Be.setFromEuler(this), this.setFromQuaternion(Be, e);
	}
	equals(e) {
...
var He = class {
...
}, Ue = 0, We = /*@__PURE__*/ new W(), Ge = /*@__PURE__*/ new pe(), Ke = /*@__PURE__*/ new Pe(), qe = /*@__PURE__*/ new W(), Je = /*@__PURE__*/ new W(), Ye = /*@__PURE__*/ new W(), Xe = /*@__PURE__*/ new pe(), Ze = /*@__PURE__*/ new W(1, 0, 0), Qe = /*@__PURE__*/ new W(0, 1, 0), $e = /*@__PURE__*/ new W(0, 0, 1), et = { type: "added" }, tt = { type: "removed" }, nt = {
	type: "childadded",
	child: null
}, rt = {
	type: "childremoved",
	child: null
}, it = class e extends B {
	constructor() {
		super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: Ue++ }), this.uuid = ce(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = e.DEFAULT_UP.clone();
		let t = new W(), n = new Ve(), r = new pe(), i = new W(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
		...
		}), this.matrix = new Pe(), this.matrixWorld = new Pe(), this.matrixAutoUpdate = e.DEFAULT_MATRIX_AUTO_UPDATE, this.matrixWorldAutoUpdate = e.DEFAULT_MATRIX_WORLD_AUTO_UPDATE, this.matrixWorldNeedsUpdate = !1, this.layers = new He(), this.visible = !0, this.castShadow = !1, this.receiveShadow = !1, this.frustumCulled = !0, this.renderOrder = 0, this.animations = [], this.customDepthMaterial = void 0, this.customDistanceMaterial = void 0, this.static = !1, this.userData = {}, this.pivot = null;
	}
	onBeforeShadow() {}
	onAfterShadow() {}
	onBeforeRender() {}
	...
	rotateOnAxis(e, t) {
		return Ge.setFromAxisAngle(e, t), this.quaternion.multiply(Ge), this;
	}
	rotateOnWorldAxis(e, t) {
		return Ge.setFromAxisAngle(e, t), this.quaternion.premultiply(Ge), this;
	}
	rotateX(e) {
	...
	worldToLocal(e) {
		return this.updateWorldMatrix(!0, !1), e.applyMatrix4(Ke.copy(this.matrixWorld).invert());
	}
	lookAt(e, t, n) {
		e.isVector3 ? qe.copy(e) : qe.set(e, t, n);
		let r = this.parent;
		this.updateWorldMatrix(!0, !1), Je.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? Ke.lookAt(Je, qe, this.up) : Ke.lookAt(qe, Je, this.up), this.quaternion.setFromRotationMatrix(Ke), r && (Ke.extractRotation(r.matrixWorld), Ge.setFromRotationMatrix(Ke), this.quaternion.premultiply(Ge.invert()));
	}
	add(e) {
		...
		return e === this ? (R("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(et), nt.child = e, this.dispatchEvent(nt), nt.child = null) : R("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
		...
		return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(tt), rt.child = e, this.dispatchEvent(rt), rt.child = null), this;
	}
	removeFromParent() {
		let e = this.parent;
	...
	attach(e) {
		return this.updateWorldMatrix(!0, !1), Ke.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(!0, !1), Ke.multiply(e.parent.matrixWorld)), e.applyMatrix4(Ke), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(!1, !0), e.dispatchEvent(et), nt.child = e, this.dispatchEvent(nt), nt.child = null, this;
	}
	getObjectById(e) {
	...
	getWorldQuaternion(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Je, e, Ye), e;
	}
	getWorldScale(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Je, Xe, e), e;
	}
	getWorldDirection(e) {
...
it.DEFAULT_UP = /*@__PURE__*/ new W(0, 1, 0), it.DEFAULT_MATRIX_AUTO_UPDATE = !0, it.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
var at = class extends it {
	...
	getTargetRaySpace() {
		return this._targetRay === null && (this._targetRay = new at(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new W(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new W()), this._targetRay;
	}
	getGripSpace() {
		return this._grip === null && (this._grip = new at(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new W(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new W(), this._grip.eventsEnabled = !1), this._grip;
	}
	dispatchEvent(e) {
...
var Z = class {
	...
	setHSL(e, t, n, r = K.workingColorSpace) {
		if (e = le(e, 1), t = H(t, 0, 1), n = H(n, 0, 1), t === 0) this.r = this.g = this.b = n;
		else {
	...
	getHex(e = O) {
		return K.workingToColorSpace(ft.copy(this), e), Math.round(H(ft.r * 255, 0, 255)) * 65536 + Math.round(H(ft.g * 255, 0, 255)) * 256 + Math.round(H(ft.b * 255, 0, 255));
	}
	getHexString(e = O) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = K.workingColorSpace) {
		K.workingToColorSpace(ft.copy(this), t);
	...
	getRGB(e, t = K.workingColorSpace) {
		return K.workingToColorSpace(ft.copy(this), t), e.r = ft.r, e.g = ft.g, e.b = ft.b, e;
	}
	getStyle(e = O) {
		K.workingToColorSpace(ft.copy(this), e);
	...
	lerpHSL(e, t) {
		...
		let n = ue(lt.h, ut.h, t), r = ue(lt.s, ut.s, t), i = ue(lt.l, ut.l, t);
...
var pt = class extends it {
...
}, mt = /*@__PURE__*/ new W(), ht = /*@__PURE__*/ new W(), gt = /*@__PURE__*/ new W(), _t = /*@__PURE__*/ new W(), vt = /*@__PURE__*/ new W(), yt = /*@__PURE__*/ new W(), bt = /*@__PURE__*/ new W(), xt = /*@__PURE__*/ new W(), St = /*@__PURE__*/ new W(), Ct = /*@__PURE__*/ new W(), wt = /*@__PURE__*/ new Ae(), Tt = /*@__PURE__*/ new Ae(), Et = /*@__PURE__*/ new Ae(), Dt = class e {
	...
	/*@__PURE__*/ new W(),
	/*@__PURE__*/ new W()
], At = /*@__PURE__*/ new W(), jt = /*@__PURE__*/ new Ot(), Mt = /*@__PURE__*/ new W(), Nt = /*@__PURE__*/ new W(), Pt = /*@__PURE__*/ new W(), Ft = /*@__PURE__*/ new W(), It = /*@__PURE__*/ new W(), Lt = /*@__PURE__*/ new W(), Rt = /*@__PURE__*/ new W(), zt = /*@__PURE__*/ new W(), Bt = /*@__PURE__*/ new W(), Vt = /*@__PURE__*/ new W();
...
var Ut = /*@__PURE__*/ new W(), Wt = /*@__PURE__*/ new U(), Gt = 0, Kt = class extends B {
	constructor(e, t, n = !1) {
	...
	getX(e) {
		...
		return this.normalized && (t = de(t, this.array)), t;
	}
	setX(e, t) {
...
}, Xt = /*@__PURE__*/ new Ot(), Zt = /*@__PURE__*/ new W(), Qt = /*@__PURE__*/ new W(), $t = class {
...
}, en = 0, tn = /*@__PURE__*/ new Pe(), nn = /*@__PURE__*/ new it(), rn = /*@__PURE__*/ new W(), an = /*@__PURE__*/ new Ot(), on = /*@__PURE__*/ new Ot(), sn = /*@__PURE__*/ new W(), cn = class e extends B {
	constructor() {
		super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: en++ }), this.uuid = ce(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
			start: 0,
			count: Infinity
	...
	computeBoundingBox() {
		...
		if (e && e.isGLBufferAttribute) {
			R("BufferGeometry.computeBoundingBox(): GLBufferAttribute requires a manual bounding box.", this), this.boundingBox.set(new W(-Infinity, -Infinity, -Infinity), new W(Infinity, Infinity, Infinity));
			return;
		}
		if (e !== void 0) {
	...
	computeBoundingSphere() {
		...
		let e = this.attributes.position, t = this.morphAttributes.position;
		if (e && e.isGLBufferAttribute) {
			R("BufferGeometry.computeBoundingSphere(): GLBufferAttribute requires a manual bounding sphere.", this), this.boundingSphere.set(new W(), Infinity);
			return;
		}
		if (e) {
...
}, ln = /*@__PURE__*/ new W(), un = /*@__PURE__*/ new W(), dn = /*@__PURE__*/ new G(), fn = class {
	...
	setFromCoplanarPoints(e, t, n) {
		let r = ln.subVectors(n, t).cross(un.subVectors(e, t)).normalize();
	...
	intersectLine(e, t, n = !0) {
		let r = e.delta(ln), i = this.normal.dot(r);
	...
	applyMatrix4(e, t) {
		let n = t || dn.getNormalMatrix(e), r = this.coplanarPoint(ln).applyMatrix4(e), i = this.normal.applyMatrix3(n).normalize();
...
}, pn = 0, mn = class extends B {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: pn++ }), this.uuid = ce(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Z(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = M, this.stencilZFail = M, this.stencilZPass = M, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, hn = /*@__PURE__*/ new W(), gn = /*@__PURE__*/ new W(), _n = /*@__PURE__*/ new W(), vn = /*@__PURE__*/ new W(), yn = class {
	...
	distanceSqToPoint(e) {
		let t = hn.subVectors(e, this.origin).dot(this.direction);
	...
	distanceSqToSegment(e, t, n, r) {
		gn.copy(e).add(t).multiplyScalar(.5), _n.copy(t).sub(e).normalize(), vn.copy(this.origin).sub(gn);
		let i = e.distanceTo(t) * .5, a = -this.direction.dot(_n), o = vn.dot(this.direction), s = -vn.dot(_n), c = vn.lengthSq(), l = Math.abs(1 - a * a), u, d, f, p;
		if (l > 0) {
		...
		return n && n.copy(this.origin).addScaledVector(this.direction, u), r && r.copy(gn).addScaledVector(_n, d), f;
	}
	intersectSphere(e, t) {
		if (e.radius < 0) return null;
		hn.subVectors(e.center, this.origin);
		let n = hn.dot(this.direction), r = hn.dot(hn) - n * n, i = e.radius * e.radius;
		if (r > i) return null;
	...
	intersectTriangle(e, t, n, r, i) {
		...
		let N = S / w, P = C / w, F = 1 / w, te = T - N * D, ne = E - P * D, re = O - N * A, I = k - P * A, L = j - N * ee, R = M - P * ee, ie = L * I - R * re, ae = te * R - ne * L, z = re * ne - I * te;
		if (r) {
			if (ie < 0 || ae < 0 || z < 0) return null;
		} else if ((ie < 0 || ae < 0 || z < 0) && (ie > 0 || ae > 0 || z > 0)) return null;
		let B = ie + ae + z;
		if (B === 0) return null;
		let V = F * (ie * D + ae * A + z * ee);
		return (B > 0 ? V < 0 : V > 0) ? null : this.at(V / B, i);
	}
	applyMatrix4(e) {
...
}, xn = /*@__PURE__*/ new Pe(), Sn = /*@__PURE__*/ new yn(), Cn = /*@__PURE__*/ new $t(), wn = /*@__PURE__*/ new W(), Tn = /*@__PURE__*/ new W(), En = /*@__PURE__*/ new W(), Dn = /*@__PURE__*/ new W(), On = /*@__PURE__*/ new W(), kn = /*@__PURE__*/ new W(), An = /*@__PURE__*/ new W(), jn = /*@__PURE__*/ new W(), Mn = class extends it {
	constructor(e = new cn(), t = new bn()) {
...
function Pn(e, t, n, r, i, a, o, s, c, l) {
	...
	if (u) {
		let e = new W();
		Dt.getBarycoord(An, Tn, En, Dn, e), i && (u.uv = Dt.getInterpolatedAttribute(i, s, c, l, e, new U())), a && (u.uv1 = Dt.getInterpolatedAttribute(a, s, c, l, e, new U())), o && (u.normal = Dt.getInterpolatedAttribute(o, s, c, l, e, new W()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
		...
		Dt.getNormal(Tn, En, Dn, t.normal), u.face = t, u.barycoord = e;
	}
	return u;
}
var Fn = class extends ke {
...
}, In = /*@__PURE__*/ new $t(), Ln = /*@__PURE__*/ new U(.5, .5), Rn = /*@__PURE__*/ new W(), zn = class {
	...
	intersectsObject(e) {
		if (e.boundingSphere !== void 0) e.boundingSphere === null && e.computeBoundingSphere(), In.copy(e.boundingSphere).applyMatrix4(e.matrixWorld);
		else {
			let t = e.geometry;
	...
	intersectsSprite(e) {
		return In.center.set(0, 0, 0), In.radius = .7071067811865476 + Ln.distanceTo(e.center), In.applyMatrix4(e.matrixWorld), this.intersectsSphere(In);
	}
	intersectsSphere(e) {
	...
	intersectsBox(e) {
		...
		for (let n = 0; n < 6; n++) {
			let r = t[n];
			if (Rn.x = r.normal.x > 0 ? e.max.x : e.min.x, Rn.y = r.normal.y > 0 ? e.max.y : e.min.y, Rn.z = r.normal.z > 0 ? e.max.z : e.min.z, r.distanceToPoint(Rn) < 0) return !1;
		}
		return !0;
	}
	containsPoint(e) {
	...
	copy(e) {
		return super.copy(e), this.source = new Te(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
	}
	toJSON(e) {
		let t = super.toJSON(e);
...
function Kn(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Jn(i)) i.isRenderTargetTexture ? (L("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
...
var Zn = {
	...
	constructor(e) {
		super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Qn, this.fragmentShader = $n, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
			clipCullDistance: !1,
			multiDraw: !1
...
var or = class {
	...
	interpolate_(e, t, n, r) {
		...
		let d = o * 2, f = e - 1;
		for (let p = 0; p !== o; ++p) {
			let o = a[c + p], m = a[s + p], h = f * d + p * 2, g = u[h], _ = u[h + 1], v = e * d + p * 2, y = l[v], b = l[v + 1], x = pr(n, t, g, y, r);
			i[p] = dr(x, o, _, b, m);
		}
		return i;
	}
...
var mr = class {
	constructor(e, t, n, r) {
		...
		this.name = e, this.times = ir(t, this.TimeBufferType), this.values = ir(n, this.ValueBufferType), this.setInterpolation(r || this.DefaultInterpolation);
	}
	static toJSON(e) {
		...
		if (t.toJSON !== this.toJSON) n = t.toJSON(e);
			...
			t !== e.DefaultInterpolation && (n.interpolation = t), ar(e.settings) && (n.settings = {
				inTangents: ir(e.settings.inTangents, Array),
				outTangents: ir(e.settings.outTangents, Array)
			});
		}
	...
	InterpolantFactoryMethodBezier(e) {
		let t = new ur(this.times, this.values, this.getValueSize(), e);
	...
	scale(e) {
		if (e !== 1) {
			let t = this.times;
			for (let n = 0, r = t.length; n !== r; ++n) t[n] *= e;
			ar(this.settings) && (hr(this.settings.inTangents, e), hr(this.settings.outTangents, e));
		}
		return this;
	}
	trim(e, t) {
	...
	clone() {
		...
		return r.createInterpolant = this.createInterpolant, ar(this.settings) && (r.settings = {
...
mr.prototype.ValueTypeName = "", mr.prototype.TimeBufferType = Float32Array, mr.prototype.ValueBufferType = Float32Array, mr.prototype.DefaultInterpolation = S;
...
var vr = class extends mr {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
vr.prototype.ValueTypeName = "number";
var yr = class extends or {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
	interpolate_(e, t, n, r) {
...
var Cr = {
	...
	files: {},
	add: function(e, t) {
		this.enabled !== !1 && (wr(e) || (this.files[e] = t));
	},
	get: function(e) {
		if (this.enabled !== !1 && !wr(e)) return this.files[e];
	},
	remove: function(e) {
		delete this.files[e];
	},
...
var Tr = /*@__PURE__*/ new class {
	...
	constructor(e) {
		this.manager = e === void 0 ? Tr : e, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {}, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
	}
	load() {}
	loadAsync(e, t) {
		let n = this;
...
var Dr = /* @__PURE__ */ new WeakMap(), Or = class extends Er {
	constructor(e) {
		super(e);
	}
	load(e, t, n, r) {
		this.path !== void 0 && (e = this.path + e), e = this.manager.resolveURL(e);
		let i = this, a = Cr.get(`image:${e}`);
		if (a !== void 0) {
		...
		function s() {
			...
			Dr.delete(this), i.manager.itemEnd(e);
		}
		function c(t) {
			l(), r && r(t), Cr.remove(`image:${e}`);
			let n = Dr.get(this) || [];
			for (let e = 0; e < n.length; e++) {
				let r = n[e];
				r.onError && r.onError(t);
			}
			Dr.delete(this), i.manager.itemError(e), i.manager.itemEnd(e);
		}
		function l() {
			o.removeEventListener("load", s, !1), o.removeEventListener("error", c, !1);
		}
		return o.addEventListener("load", s, !1), o.addEventListener("error", c, !1), e.slice(0, 5) !== "data:" && this.crossOrigin !== void 0 && (o.crossOrigin = this.crossOrigin), Cr.add(`image:${e}`, o), i.manager.itemStart(e), o.src = e, o;
	}
}, kr = class extends Er {
	constructor(e) {
		super(e);
	...
	load(e, t, n, r) {
		let i = new ke(), a = new Or(this.manager);
		return a.setCrossOrigin(this.crossOrigin), a.setPath(this.path), a.load(e, function(e) {
			i.image = e, i.needsUpdate = !0, t !== void 0 && t(i);
		}, n, r), i;
	}
}, Ar = /*@__PURE__*/ new W(), jr = /*@__PURE__*/ new pe(), Mr = /*@__PURE__*/ new W(), Nr = class extends it {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Pe(), this.projectionMatrix = new Pe(), this.projectionMatrixInverse = new Pe(), this.coordinateSystem = ee, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(Ar, jr, Mr), Mr.x === 1 && Mr.y === 1 && Mr.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Ar, jr, Mr.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(Ar, jr, Mr), Mr.x === 1 && Mr.y === 1 && Mr.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Ar, jr, Mr.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, Pr = /*@__PURE__*/ new W(), Fr = /*@__PURE__*/ new U(), Ir = /*@__PURE__*/ new U(), Lr = class extends Nr {
	...
	setFocalLength(e) {
		...
		this.fov = se * 2 * Math.atan(t), this.updateProjectionMatrix();
	}
	getFocalLength() {
		let e = Math.tan(oe * .5 * this.fov);
		return .5 * this.getFilmHeight() / e;
	}
	getEffectiveFOV() {
		return se * 2 * Math.atan(Math.tan(oe * .5 * this.fov) / this.zoom);
	}
	getFilmWidth() {
	...
	getViewBounds(e, t, n) {
		Pr.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(Pr.x, Pr.y).multiplyScalar(-e / Pr.z), Pr.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(Pr.x, Pr.y).multiplyScalar(-e / Pr.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, Fr, Ir), t.subVectors(Ir, Fr);
	}
	...
	updateProjectionMatrix() {
		let e = this.near, t = e * Math.tan(oe * .5 * this.fov) / this.zoom, n = 2 * t, r = this.aspect * n, i = -.5 * r, a = this.view;
...
}, zr = -90, Br = 1, Vr = class extends it {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new Lr(zr, Br, e, t);
		r.layers = this.layers, this.add(r);
		let i = new Lr(zr, Br, e, t);
		i.layers = this.layers, this.add(i);
		let a = new Lr(zr, Br, e, t);
		a.layers = this.layers, this.add(a);
		let o = new Lr(zr, Br, e, t);
		o.layers = this.layers, this.add(o);
		let s = new Lr(zr, Br, e, t);
		s.layers = this.layers, this.add(s);
		let c = new Lr(zr, Br, e, t);
...
}, Ur = "\\[\\]\\.:\\/", Wr = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), Gr = "[^\\[\\]\\.:\\/]", Kr = "[^" + Ur.replace("\\.", "") + "]", qr = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", Gr), Jr = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", Kr), Yr = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", Gr), Xr = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", Gr), Zr = RegExp("^" + qr + Jr + Yr + Xr + "$"), Qr = [
	"material",
	"materials",
	"bones",
	"map"
	...
	static parseTrackName(e) {
		...
		if (r !== void 0 && r !== -1) {
			...
			Qr.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = e);
		}
...
ei.Composite = $r, ei.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
...
var Q = {
	...
	points: {
		uniforms: /*@__PURE__*/ qn([$.points, $.fog]),
	...
	depth: {
		uniforms: /*@__PURE__*/ qn([$.common, $.displacementmap]),
	...
	sprite: {
		uniforms: /*@__PURE__*/ qn([$.sprite, $.fog]),
...
ai.physical = {
	uniforms: /*@__PURE__*/ qn([ai.standard.uniforms, {
		clearcoat: { value: 0 },
...
var oi = {
	...
	b: 0,
	g: 0
}, si = /*@__PURE__*/ new Pe(), ci = /*@__PURE__*/ new G();
ci.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function li(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Mn(new Wn(1, 1, 1), new er({
			name: "BackgroundCubeMaterial",
			uniforms: Kn(ai.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(si.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(ci), l.material.toneMapped = K.getTransfer(i.colorSpace) !== j, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new Mn(new Gn(2, 2), new er({
			name: "BackgroundMaterial",
			uniforms: Kn(ai.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(oi, Xn(e)), n.buffers.color.setClear(oi.r, oi.g, oi.b, r, a);
	}
	function _() {
...
function pi(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new fn(), s = new G(), c = {
		value: null,
		needsUpdate: !1
	};
...
var mi = 4, hi = 6, gi = 20, _i = 256, vi = /*@__PURE__*/ new Rr(), yi = /*@__PURE__*/ new Z(), bi = null, xi = 0, Si = 0, Ci = !1, wi = /*@__PURE__*/ new W(), Ti = /*@__PURE__*/ new W(), Ei = class {
	constructor(e) {
	...
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = wi } = i;
		bi = this._renderer.getRenderTarget(), xi = this._renderer.getActiveCubeFace(), Si = this._renderer.getActiveMipmapLevel(), Ci = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(bi, xi, Si), this._renderer.xr.enabled = Ci, e.scissorTest = !1, ki(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), bi = this._renderer.getRenderTarget(), xi = this._renderer.getActiveCubeFace(), Si = this._renderer.getActiveMipmapLevel(), Ci = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods} = Di(r)), this._blurMaterial = ji(r, e, t), this._ggxMaterial = Ai(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new Mn(new cn(), e);
		this._renderer.compile(t, vi);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new Lr(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(yi), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Mn(new Wn(), new bn({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(yi), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
	...
	_textureToCubeUV(e, t) {
		...
		ki(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, vi);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - mi ? n - d + mi : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, ki(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, vi), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, ki(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, vi);
	}
	_blur(e, t, n, r) {
	...
	_blurPass(e, t, n, r, i) {
		...
		ki(t, 3 * l * (r > this._lodMax - mi ? r - this._lodMax + mi : 0), 4 * (this._cubeSize - l), 3 * l, 2 * l), a.setRenderTarget(t), a.render(s, vi);
	}
};
function Di(e) {
	let t = [], n = [], r = e, i = e - mi + 1 + hi;
	for (let e = 0; e < i; e++) {
		let e = 2 ** r;
		t.push(e);
		...
		for (let e = 0; e < 6; e++) {
			...
			for (let t = 0; t < 6; t++) {
				...
				e === 0 ? Ti.set(1, r, n) : e === 1 ? Ti.set(-n, 1, -r) : e === 2 ? Ti.set(-n, r, 1) : e === 3 ? Ti.set(-1, r, -n) : e === 4 ? Ti.set(-n, -1, r) : Ti.set(n, r, -1), Ti.toArray(l, (e * 6 + t) * 3);
			}
		}
		let u = new cn();
		u.setAttribute("position", new Kt(c, 3)), u.setAttribute("outputDirection", new Kt(l, 3)), n.push(new Mn(u, null)), r > mi && r--;
	}
	return {
		lodMeshes: n,
		sizeLods: t
...
var Fi = class extends Me {
	constructor(e = 1, t = {}) {
		...
		this.texture = new Bn(r), this._setTextureOptions(t), this.texture.isRenderTargetTexture = !0;
	}
	fromEquirectangularTexture(e, t) {
		...
		return t.minFilter === 1008 && (t.minFilter = i), new Vr(1, 10, this).update(e, o), t.minFilter = s, o.geometry.dispose(), o.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
...
function Vi(e, t, n) {
	let r = /* @__PURE__ */ new WeakMap(), i = new Ae();
	function a(a, o, s) {
		...
		if (f === void 0 || f.count !== d) {
			...
			let g = new Float32Array(m * h * 4 * d), _ = new q(g, m, h, d);
...
function Wi(e, t, n, r, i, a) {
	...
	}), s = null, c = null, l = new cn();
	l.setAttribute("position", new Yt([
		-1,
		3,
		0,
		-1,
	...
	let d = new tr({
		...
		depthTest: !1,
		depthWrite: !1
	}), f = new Mn(l, d), p = new Rr(-1, 1, 1, -1, 0, 1), m = null, h = null, g = !1, _, v = null, y = [], b = !1;
	this.setSize = function(e, t) {
		...
		y.length > 0 && s === null && (s = new Me(t, n, {
			type: u,
			depthBuffer: !1,
			stencilBuffer: !1
		}), c = new Me(t, n, {
		...
		if (m !== e.outputColorSpace || h !== e.toneMapping) {
			m = e.outputColorSpace, h = e.toneMapping, d.defines = {}, K.getTransfer(m) === "srgb" && (d.defines.SRGB_TRANSFER = "");
			let t = Ui[h];
...
var Gi = /*@__PURE__*/ new ke(), Ki = /*@__PURE__*/ new Vn(1, 1), qi = /*@__PURE__*/ new q(), Ji = /*@__PURE__*/ new Ne(), Yi = /*@__PURE__*/ new Bn(), Xi = [], Zi = [], Qi = /* @__PURE__ */ new Float32Array(16), $i = /* @__PURE__ */ new Float32Array(9), ea = /* @__PURE__ */ new Float32Array(4);
function ta(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Xi[i];
...
var no = /*@__PURE__*/ new G();
function ro(e) {
	K._getMatrix(no, K.workingColorSpace, e);
...
var co = /*@__PURE__*/ new W();
function lo() {
	return K.getLuminanceCoefficients(co), [
...
function zo(e, t, n, r, i, a) {
	let o = new He(), s = new Io(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let De = {
			...
			displacementMap: ie,
			emissiveMap: ae,
			normalMapObjectSpace: R && i.normalMapType === 1,
			normalMapTangentSpace: R && i.normalMapType === 0,
			packedNormalMap: R && i.normalMapType === 0 && Ro(i.normalMap.format),
			metalnessMap: z,
			roughnessMap: B,
			anisotropy: V,
			anisotropyMap: de,
			...
			normalMapUv: R && m(i.normalMap.channel),
			...
			clearcoatNormalMapUv: U && m(i.clearcoatNormalMap.channel),
			clearcoatRoughnessMapUv: pe && m(i.clearcoatRoughnessMap.channel),
			iridescenceMapUv: W && m(i.iridescenceMap.channel),
			...
			specularColorMapUv: _e && m(i.specularColorMap.channel),
			...
			vertexTangents: !!v.attributes.tangent && (R || V),
			vertexNormals: !!v.attributes.normal,
			vertexColors: i.vertexColors,
			vertexAlphas: i.vertexColors === !0 && !!v.attributes.color && v.attributes.color.itemSize === 4,
			pointsUvs: h.isPoints === !0 && !!v.attributes.uv && (P || Se),
			fog: !!_,
			useFog: i.fog === !0,
			fogExp2: !!_ && _.isFogExp2,
			flatShading: i.wireframe === !1 && (i.flatShading === !0 || v.attributes.normal === void 0 && R === !1 && (i.isMeshLambertMaterial || i.isMeshPhongMaterial || i.isMeshStandardMaterial || i.isMeshPhysicalMaterial)),
			...
			decodeVideoTextureEmissive: ae && i.emissiveMap.isVideoTexture === !0 && K.getTransfer(i.emissiveMap.colorSpace) === "srgb",
			...
			extensionMultiDraw: (Te && i.extensions.multiDraw === !0 || N) && n.has("WEBGL_multi_draw"),
...
function Uo() {
	...
	function u(e, t) {
		n.length > 1 && n.sort(e || Vo), r.length > 1 && r.sort(t || Ho), i.length > 1 && i.sort(t || Ho);
	}
	function d() {
...
var Qo = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", $o = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", es = [
	...
	/*@__PURE__*/ new W(0, -1, 0),
	/*@__PURE__*/ new W(0, -1, 0)
], ns = /*@__PURE__*/ new Pe(), rs = /*@__PURE__*/ new W(), is = /*@__PURE__*/ new W();
function as(e, t, n) {
	let a = new zn(), o = new U(), s = new U(), d = new Ae(), f = new nr(), p = new rr(), m = {}, g = n.maxTextureSize, _ = {
		0: 1,
		1: 0,
		2: 2
	}, y = new er({
			...
			if (_.camera._reversedDepth = S, _.map === null || b === !0) {
				if (_.map !== null && (_.map.depthTexture !== null && (_.map.depthTexture.dispose(), _.map.depthTexture = null), _.map.dispose()), this.type === 3) {
					...
					_.map = new Me(o.x, o.y, {
						...
						magFilter: i,
						generateMipmaps: !1
					}), _.map.texture.name = m.name + ".shadowMap", _.map.depthTexture = new Vn(o.x, o.y, l), _.map.depthTexture.name = m.name + ".shadowMapDepth", _.map.depthTexture.format = h, _.map.depthTexture.compareFunction = null, _.map.depthTexture.minFilter = r, _.map.depthTexture.magFilter = r;
				} else m.isPointLight ? (_.map = new Fi(o.x), _.map.depthTexture = new Hn(o.x, c)) : (_.map = new Me(o.x, o.y), _.map.depthTexture = new Vn(o.x, o.y, c)), _.map.depthTexture.name = m.name + ".shadowMap", _.map.depthTexture.format = h, this.type === 1 ? (_.map.depthTexture.compareFunction = S ? 518 : 515, _.map.depthTexture.minFilter = i, _.map.depthTexture.magFilter = i) : (_.map.depthTexture.compareFunction = null, _.map.depthTexture.minFilter = r, _.map.depthTexture.magFilter = r);
	...
	function T(n, r) {
		let i = t.update(S);
		y.defines.VSM_SAMPLES !== n.blurSamples && (y.defines.VSM_SAMPLES = n.blurSamples, b.defines.VSM_SAMPLES = n.blurSamples, y.needsUpdate = !0, b.needsUpdate = !0), n.mapPass === null ? n.mapPass = new Me(o.x, o.y, {
			format: v,
			type: u
		}) : (n.mapPass.width !== n.map.width || n.mapPass.height !== n.map.height) && n.mapPass.setSize(n.map.width, n.map.height), y.uniforms.shadow_pass.value = n.map.depthTexture, y.uniforms.resolution.value.set(n.map.width, n.map.height), y.uniforms.radius.value = n.radius, e.setRenderTarget(n.mapPass), e.clear(), e.renderBufferDirect(r, null, i, y, S, null), b.uniforms.shadow_pass.value = n.mapPass.texture, b.uniforms.resolution.value.set(n.map.width, n.map.height), b.uniforms.radius.value = n.radius, e.setRenderTarget(n.map), e.clear(), e.renderBufferDirect(r, null, i, b, S, null);
	}
	function E(t, n, r, i) {
...
function os(e, t) {
	function n() {
		let t = !1, n = new Ae(), r = null, i = new Ae(0, 0, 0, 0);
		return {
			setMask: function(n) {
	...
	let a = new n(), o = new r(), s = new i(), c = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), u = {}, d = {}, f = {}, p = /* @__PURE__ */ new WeakMap(), m = [], h = null, g = !1, _ = null, v = null, y = null, b = null, x = null, S = null, C = null, w = new Z(0, 0, 0), T = 0, E = !1, D = null, O = null, k = null, A = null, j = null, M = e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS), ee = !1, N = 0, P = e.getParameter(e.VERSION);
	P.indexOf("WebGL") === -1 ? P.indexOf("OpenGL ES") !== -1 && (N = parseFloat(/^OpenGL ES (\d)/.exec(P)[1]), ee = N >= 2) : (N = parseFloat(/^WebGL (\d)/.exec(P)[1]), ee = N >= 1);
	let F = null, te = {}, ne = e.getParameter(e.SCISSOR_BOX), re = e.getParameter(e.VIEWPORT), I = new Ae().fromArray(ne), L = new Ae().fromArray(re);
	function ie(t, n, r, i) {
	...
	function ue(t, n, r, i, a, o, s, c, l, u) {
		...
		a ||= n, o ||= r, s ||= i, (n !== v || a !== x) && (e.blendEquationSeparate(H[n], H[a]), v = n, x = a), (r !== y || i !== b || o !== S || s !== C) && (e.blendFuncSeparate(le[r], le[i], le[o], le[s]), y = r, b = i, S = o, C = s), (c.equals(w) === !1 || l !== T) && (e.blendColor(c.r, c.g, c.b, l), w.copy(c), T = l), _ = t, E = !1;
	}
	function de(t, n) {
		...
		s.setTest(i), i && (s.setMask(t.stencilWriteMask), s.setFunc(t.stencilFunc, t.stencilRef, t.stencilFuncMask), s.setOp(t.stencilFail, t.stencilZFail, t.stencilZPass)), W(t.polygonOffset, t.polygonOffsetFactor, t.polygonOffsetUnits), t.alphaToCoverage === !0 ? B(e.SAMPLE_ALPHA_TO_COVERAGE) : V(e.SAMPLE_ALPHA_TO_COVERAGE);
	}
	function fe(t) {
		D !== t && (t ? e.frontFace(e.CW) : e.frontFace(e.CCW), D = t);
	}
	function U(t) {
		t === 0 ? V(e.CULL_FACE) : (B(e.CULL_FACE), t !== O && (t === 1 ? e.cullFace(e.BACK) : t === 2 ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK))), O = t;
	}
	function pe(t) {
		t !== k && (ee && e.lineWidth(t), k = t);
	}
	function W(t, n, r) {
		t ? (B(e.POLYGON_OFFSET_FILL), (A !== n || j !== r) && (A = n, j = r, o.getReversed() && (n = -n), e.polygonOffset(n, r))) : V(e.POLYGON_OFFSET_FILL);
	}
	function me(t) {
	...
	function G(t, n, r) {
		...
		i === void 0 && (i = {
			type: void 0,
			texture: void 0
		}, te[r] = i), (i.type !== t || i.texture !== n) && (F !== r && (e.activeTexture(r), F = r), e.bindTexture(t, n || ae[t]), i.type = t, i.texture = n);
	}
	function ge() {
		let t = te[F];
...
function ss(o, s, c, l, u, d, f) {
	...
	function j(e) {
		let t = e.target;
		t.removeEventListener("dispose", j), ee(t), t.isVideoTexture && _.delete(t), t.isHTMLTexture && v.delete(t);
	}
	function M(e) {
		let t = e.target;
		t.removeEventListener("dispose", M), P(t);
	}
	function ee(e) {
		let t = l.get(e);
	...
	function le(e, t) {
		if (t.type === 1015 && s.has("OES_texture_float_linear") === !1 && (t.magFilter === 1006 || t.magFilter === 1007 || t.magFilter === 1005 || t.magFilter === 1008 || t.minFilter === 1006 || t.minFilter === 1007 || t.minFilter === 1005 || t.minFilter === 1008) && L("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), o.texParameteri(e, o.TEXTURE_WRAP_S, se[t.wrapS]), o.texParameteri(e, o.TEXTURE_WRAP_T, se[t.wrapT]), (e === o.TEXTURE_3D || e === o.TEXTURE_2D_ARRAY) && o.texParameteri(e, o.TEXTURE_WRAP_R, se[t.wrapR]), o.texParameteri(e, o.TEXTURE_MAG_FILTER, ce[t.magFilter]), o.texParameteri(e, o.TEXTURE_MIN_FILTER, ce[t.minFilter]), t.compareFunction && (o.texParameteri(e, o.TEXTURE_COMPARE_MODE, o.COMPARE_REF_TO_TEXTURE), o.texParameteri(e, o.TEXTURE_COMPARE_FUNC, H[t.compareFunction])), s.has("EXT_texture_filter_anisotropic") === !0) {
			...
			if (t.isDepthTexture) p = O(t.format === g, t.type), y && (_ ? c.texStorage2D(o.TEXTURE_2D, 1, p, e.width, e.height) : c.texImage2D(o.TEXTURE_2D, 0, p, e.width, e.height, 0, l, f, null));
							...
							if (_) {
								if (b) {
									if (t.layerUpdates.size > 0) {
										let e = ti(m.width, m.height, t.format, t.type);
				...
				if (_) {
					if (y && c.texStorage3D(o.TEXTURE_2D_ARRAY, x, p, e.width, e.height, e.depth), b) {
						if (t.layerUpdates.size > 0) {
							let n = ti(e.width, e.height, t.format, t.type);
							for (let r of t.layerUpdates) {
	...
	function G(e, t, n) {
		...
		if (i.__renderTarget = t, (!i.__webglTexture || t.depthTexture.image.width !== t.width || t.depthTexture.image.height !== t.height) && (t.depthTexture.image.width = t.width, t.depthTexture.image.height = t.height, t.depthTexture.needsUpdate = !0), r) {
			if (i.__webglInit === void 0 && (i.__webglInit = !0, t.depthTexture.addEventListener("dispose", j)), i.__webglTexture === void 0) {
				i.__webglTexture = o.createTexture(), c.bindTexture(o.TEXTURE_CUBE_MAP, i.__webglTexture), le(o.TEXTURE_CUBE_MAP, t.depthTexture);
	...
	function ge(e) {
		...
		if (e.depthTexture && !t.__autoAllocateDepthBuffer) {
			if (n) for (let n = 0; n < 6; n++) G(t.__webglFramebuffer[n], e, n);
			else {
				let n = e.texture.mipmaps;
				n && n.length > 0 ? G(t.__webglFramebuffer[0], e, 0) : G(t.__webglFramebuffer, e, 0);
			}
		} else if (n) {
	...
	function _e(e, t, n) {
		let r = l.get(e);
		t !== void 0 && me(r.__webglFramebuffer, e, e.texture, o.COLOR_ATTACHMENT0, o.TEXTURE_2D, 0), n !== void 0 && ge(e);
	}
	function ve(e) {
		...
		if (a) {
			c.bindTexture(o.TEXTURE_CUBE_MAP, r.__webglTexture), le(o.TEXTURE_CUBE_MAP, t);
			for (let r = 0; r < 6; r++) if (t.mipmaps && t.mipmaps.length > 0) for (let i = 0; i < t.mipmaps.length; i++) me(n.__webglFramebuffer[r][i], e, t, o.COLOR_ATTACHMENT0, o.TEXTURE_CUBE_MAP_POSITIVE_X + r, i);
			else me(n.__webglFramebuffer[r], e, t, o.COLOR_ATTACHMENT0, o.TEXTURE_CUBE_MAP_POSITIVE_X + r, 0);
			w(t) && T(o.TEXTURE_CUBE_MAP), c.unbindTexture();
		} else if (s) {
			for (let t = 0, r = i.length; t < r; t++) {
				let r = i[t], a = l.get(r), s = o.TEXTURE_2D;
				(e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (s = e.isWebGL3DRenderTarget ? o.TEXTURE_3D : o.TEXTURE_2D_ARRAY), c.bindTexture(s, a.__webglTexture), le(s, r), me(n.__webglFramebuffer, e, r, o.COLOR_ATTACHMENT0 + t, s, 0), w(r) && T(s);
			}
			c.unbindTexture();
		} else {
			let i = o.TEXTURE_2D;
			if ((e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (i = e.isWebGL3DRenderTarget ? o.TEXTURE_3D : o.TEXTURE_2D_ARRAY), c.bindTexture(i, r.__webglTexture), le(i, t), t.mipmaps && t.mipmaps.length > 0) for (let r = 0; r < t.mipmaps.length; r++) me(n.__webglFramebuffer[r], e, t, o.COLOR_ATTACHMENT0, i, r);
			else me(n.__webglFramebuffer, e, t, o.COLOR_ATTACHMENT0, i, 0);
	...
	function Ee(e, t) {
		...
		return e.isCompressedTexture === !0 || e.isVideoTexture === !0 || n !== "srgb-linear" && n !== "" && (K.getTransfer(n) === "srgb" ? (r !== 1023 || i !== 1009) && L("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : R("WebGLTextures: Unsupported texture color space:", n)), t;
	}
	function De(e) {
	...
	this.allocateTextureUnit = ie, this.resetTextureUnits = ne, this.getTextureUnits = re, this.setTextureUnits = I, this.setTexture2D = z, this.setTexture2DArray = B, this.setTexture3D = V, this.setTextureCube = oe, this.rebindTextures = _e, this.setupRenderTarget = ve, this.updateRenderTargetMipmap = ye, this.updateMultisampleRenderTarget = Se, this.setupDepthRenderbuffer = ge, this.setupFrameBufferTexture = me, this.useMultisampledRTT = we, this.isReversedDepthBuffer = function() {
...
var ls = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", us = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", ds = class {
	...
	init(e, t) {
		if (this.texture === null) {
			let n = new Un(e.texture);
			(e.depthNear !== t.depthNear || e.depthFar !== t.depthFar) && (this.depthNear = e.depthNear, this.depthFar = e.depthFar), this.texture = n;
		}
	}
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			let t = e.cameras[0].viewport, n = new er({
				vertexShader: ls,
				fragmentShader: us,
				uniforms: {
			...
			this.mesh = new Mn(new Gn(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, s = "local-floor", l = 1, u = null, d = null, f = null, _ = null, v = null, y = null, b = typeof XRWebGLBinding < "u", x = new ds(), S = {}, C = t.getContextAttributes(), w = null, T = null, E = [], D = [], O = new U(), k = null, A = null, j = new Lr();
		j.viewport = new Ae();
		let M = new Lr();
		M.viewport = new Ae();
		let ee = [j, M], N = new Hr(), P = null, F = null;
		...
		this.setFramebufferScaleFactor = function(e) {
			...
			if (r = d, r !== null) {
				if (w = e.getRenderTarget(), r.addEventListener("select", te), r.addEventListener("selectstart", te), r.addEventListener("selectend", te), r.addEventListener("squeeze", te), r.addEventListener("squeezestart", te), r.addEventListener("squeezeend", te), r.addEventListener("end", ne), r.addEventListener("inputsourceschange", re), C.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(O), b && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					f = this.getBinding(), _ = f.createProjectionLayer(l), r.updateRenderState({ layers: [_] }), e.setPixelRatio(1), e.setSize(_.textureWidth, _.textureHeight, !1), T = new Me(_.textureWidth, _.textureHeight, {
						format: m,
						type: o,
						depthTexture: new Vn(_.textureWidth, _.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, n),
		...
		let I = new W(), R = new W();
		function ie(e, t, n) {
			I.setFromMatrixPosition(t.matrixWorld), R.setFromMatrixPosition(n.matrixWorld);
			let r = I.distanceTo(R), i = t.projectionMatrix.elements, a = n.projectionMatrix.elements, o = i[14] / (i[10] - 1), s = i[14] / (i[10] + 1), c = (i[9] + 1) / i[5], l = (i[9] - 1) / i[5], u = (i[8] - 1) / i[0], d = (a[8] + 1) / a[0], f = o * u, p = o * d, m = r / (-u + d), h = m * -u;
		...
		this.updateCamera = function(e) {
			...
			x.texture !== null && (x.depthNear > 0 && (t = x.depthNear), x.depthFar > 0 && (n = x.depthFar)), N.near = M.near = j.near = t, N.far = M.far = j.far = n, (P !== N.near || F !== N.far) && (r.updateRenderState({
				depthNear: N.near,
				depthFar: N.far
			...
			a.length === 2 ? ie(N, j, M) : N.projectionMatrix.copy(j.projectionMatrix), A === null && e.isPerspectiveCamera && (A = {
				camera: e,
				fov: e.fov,
				zoom: e.zoom
			}), z(e, N, i);
		...
		let oe = new ri();
		oe.setAnimationLoop(V), this.setAnimationLoop = function(e) {
			B = e;
		}, this.dispose = function() {};
	}
}, ps = /*@__PURE__*/ new Pe(), ms = /*@__PURE__*/ new G();
...
function hs(e, t) {
	...
	function r(t, n) {
		n.color.getRGB(t.fogColor.value, Xn(e)), n.isFog ? (t.fogNear.value = n.near, t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density);
	}
...
function ys() {
	return vs === null && (vs = new Fn(_s, 16, 16, v, u), vs.name = "DFG_LUT", vs.minFilter = i, vs.magFilter = i, vs.wrapS = t, vs.wrapT = t, vs.generateMipmaps = !1, vs.needsUpdate = !0), vs;
}
var bs = class {
	constructor(e = {}) {
		let { canvas: t = te(), context: n = null, depth: r = !0, stencil: i = !1, alpha: l = !1, antialias: m = !1, premultipliedAlpha: h = !0, preserveDrawingBuffer: g = !1, powerPreference: v = "default", failIfMajorPerformanceCaveat: x = !1, reversedDepthBuffer: S = !1, outputBufferType: C = o } = e;
		...
		let T = C, E = /* @__PURE__ */ new Set([
			...
			d,
			f
		]), k = /* @__PURE__ */ new Uint32Array(4), A = /* @__PURE__ */ new Int32Array(4), j = new W(), M = null, N = null, P = [], F = [], ne = null;
		this.domElement = t, this.debug = {
			checkShaderErrors: !0,
			diagnostics: { keywords: !1 },
			onShaderError: null
		}, this.autoClear = !0, this.autoClearColor = !0, this.autoClearDepth = !0, this.autoClearStencil = !0, this.sortObjects = !0, this.clippingPlanes = [], this.localClippingEnabled = !1, this.toneMapping = 0, this.toneMappingExposure = 1, this.transmissionResolutionScale = 1;
		let I = this, ie = !1, z = null, B = null, V = null, oe = null;
		this._outputColorSpace = O;
		let se = 0, ce = 0, H = null, le = -1, ue = null, de = new Ae(), fe = new Ae(), U = null, pe = new Z(0), me = 0, he = t.width, G = t.height, ge = 1, _e = null, ve = null, ye = new Ae(0, 0, he, G), be = new Ae(0, 0, he, G), xe = !1, Se = new zn(), Ce = !1, we = !1, Te = new Pe(), Ee = new W(), De = new Ae(), Oe = {
			background: null,
			fog: null,
			environment: null,
		...
		let Fe, Ie, J, Le, Y, X, Re, ze, Be, Ve, He, Ue, We, Ge, Ke, qe, Je, Ye, Xe, Ze, Qe, $e, et;
		try {
			let e = {
				alpha: !0,
				depth: r,
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r186"), t.addEventListener("webglcontextlost", rt, !1), t.addEventListener("webglcontextrestored", it, !1), t.addEventListener("webglcontextcreationerror", at, !1), q === null) {
				let t = "webgl2";
			...
			throw t.removeEventListener("webglcontextlost", rt, !1), t.removeEventListener("webglcontextrestored", it, !1), t.removeEventListener("webglcontextcreationerror", at, !1), R("WebGLRenderer: " + e.message), e;
		}
		function tt() {
			Fe = new Li(q), Fe.init(), Qe = new cs(q, Fe), Ie = new fi(q, Fe, e, Qe), J = new os(q, Fe), Ie.reversedDepthBuffer && S && J.buffers.depth.setReversed(!0), B = q.createFramebuffer(), V = q.createFramebuffer(), oe = q.createFramebuffer(), Le = new Bi(q), Y = new Bo(), X = new ss(q, Fe, J, Y, Ie, Qe, Le), Re = new Ii(I), ze = new ii(q), $e = new ui(q, ze), Be = new Ri(q, ze, Le, $e), Ve = new Hi(q, Be, ze, $e, Le), Ye = new Vi(q, Ie, X), Ke = new pi(Y), He = new zo(I, Re, Fe, Ie, $e, Ke), Ue = new hs(I, Y), We = new Wo(), Ge = new Zo(Fe), Je = new li(I, Re, J, Ve, w, h), qe = new as(I, Ve, Ie), et = new gs(q, Le, Ie, J), Xe = new di(q, Fe, Le), Ze = new zi(q, Fe, Le), Le.programs = He.programs, I.capabilities = Ie, I.extensions = Fe, I.properties = Y, I.renderLists = We, I.shadowMap = qe, I.state = J, I.info = Le;
		}
		T !== 1009 && (ne = new Wi(T, t.width, t.height, m, r, i));
		let nt = new fs(I, q);
		this.xr = nt, this.getContext = function() {
			...
			e !== void 0 && (ge = e, this.setSize(he, G, !1));
			...
			he = e, G = n, t.width = Math.floor(e * ge), t.height = Math.floor(n * ge), r === !0 && (t.style.width = e + "px", t.style.height = n + "px"), ne !== null && ne.setSize(t.width, t.height), this.setViewport(0, 0, e, n);
		}, this.getDrawingBufferSize = function(e) {
			return e.set(he * ge, G * ge).floor();
		}, this.setDrawingBufferSize = function(e, n, r) {
			he = e, G = n, ge = r, t.width = Math.floor(e * r), t.height = Math.floor(n * r), this.setViewport(0, 0, e, n);
		}, this.setEffects = function(e) {
			if (T === 1009) {
			...
			e.isVector4 ? ye.set(e.x, e.y, e.z, e.w) : ye.set(e, t, n, r), J.viewport(de.copy(ye).multiplyScalar(ge).round());
		}, this.getScissor = function(e) {
			return e.copy(be);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? be.set(e.x, e.y, e.z, e.w) : be.set(e, t, n, r), J.scissor(fe.copy(be).multiplyScalar(ge).round());
			...
			if (e) {
				let e = !1;
				if (H !== null) {
					let t = H.texture.format;
					e = E.has(t);
				}
				if (e) {
					let e = H.texture.type, t = D.has(e), n = Je.getClearColor(), r = Je.getClearAlpha(), i = n.r, a = n.g, o = n.b;
					t ? (k[0] = i, k[1] = a, k[2] = o, k[3] = r, q.clearBufferuiv(q.COLOR, 0, k)) : (A[0] = i, A[1] = a, A[2] = o, A[3] = r, q.clearBufferiv(q.COLOR, 0, A));
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			...
			$e.setup(i, r, s, n, c);
			let h, g = Xe;
			if (c !== null && (h = ze.get(c), g = Ze, g.setIndex(h)), i.isMesh) r.wireframe === !0 ? (J.setLineWidth(r.wireframeLinewidth * je()), g.setMode(q.LINES)) : g.setMode(q.TRIANGLES);
			else if (i.isLine) {
				let e = r.linewidth;
				e === void 0 && (e = 1), J.setLineWidth(e * je()), i.isLineSegments ? g.setMode(q.LINES) : i.isLineLoop ? g.setMode(q.LINE_LOOP) : g.setMode(q.LINE_STRIP);
		...
		function lt(e, t, n, r) {
			z !== null && e.isNodeMaterial && z.setObject(r, e), Ce === !0 && Ke.setState(e, n, !1), e.transparent === !0 && e.side === 2 && e.forceSinglePass === !1 ? (e.side = 1, e.needsUpdate = !0, bt(e, t, r), e.side = 0, e.needsUpdate = !0, bt(e, t, r), e.side = 2) : bt(e, t, r);
		}
		this.compile = function(e, t, n = null) {
			n === null && (n = e), z !== null && z.renderStart(e, t, n), N = Ge.get(n), N.init(t), F.push(N), n.traverseVisible(function(e) {
				e.isLight && e.layers.test(t.layers) && (N.pushLight(e), e.castShadow && N.pushShadow(e));
			}), e !== n && e.traverseVisible(function(e) {
				e.isLight && e.layers.test(t.layers) && (N.pushLight(e), e.castShadow && N.pushShadow(e));
			}), N.setupLights(), z !== null && z.updateLights(N.state.lightsArray), we = this.localClippingEnabled, Ce = Ke.init(this.clippingPlanes, we), Ce === !0 && Ke.setGlobalState(this.clippingPlanes, t), z !== null && qe.render(N.state.shadowsArray, n, t);
		...
		mt.setAnimationLoop(dt), typeof self < "u" && mt.setContext(self), this.setAnimationLoop = function(e) {
			...
			H !== null && ce === 0 && (X.updateMultisampleRenderTarget(H), X.updateRenderTargetMipmap(H)), r && ne.end(I), e.isScene === !0 && e.onAfterRender(I, e, t), $e.resetDefaultState(), le = -1, ue = null, F.pop(), F.length > 0 ? (N = F[F.length - 1], X.setTextureUnits(N.state.textureUnits), Ce === !0 && Ke.setGlobalState(I.clippingPlanes, N.state.camera)) : N = null, P.pop(), M = P.length > 0 ? P[P.length - 1] : null, z !== null && z.renderEnd();
		};
		function ht(e, t, n, r) {
			...
			if (e.layers.test(t.layers)) {
				if (e.isGroup) n = e.renderOrder;
					...
					if (!e.frustumCulled || e.intersectsFrustum(Se)) {
						...
						a.visible && M.push(e, i, a, n, De.z, null, t);
					}
					...
					if (r && (e.boundingSphere === void 0 ? (i.boundingSphere === null && i.computeBoundingSphere(), De.copy(i.boundingSphere.center)) : (e.boundingSphere === null && e.computeBoundingSphere(), De.copy(e.boundingSphere.center)), De.applyMatrix4(e.matrixWorld).applyMatrix4(Te)), Array.isArray(a)) {
						...
						for (let o = 0, s = r.length; o < s; o++) {
							...
							c && c.visible && M.push(e, i, c, n, De.z, s, t);
						}
					} else a.visible && M.push(e, i, a, n, De.z, null, t);
				}
			}
			let i = e.children;
		...
		function gt(e, t, n, r) {
			...
			N.setupLightsView(n), Ce === !0 && Ke.setGlobalState(I.clippingPlanes, n), r && J.viewport(de.copy(r)), i.length > 0 && vt(i, t, n), a.length > 0 && vt(a, t, n), o.length > 0 && vt(o, t, n), J.buffers.depth.setTest(!0), J.buffers.depth.setMask(!0), J.buffers.color.setMask(!0), J.setPolygonOffset(!1);
		}
		function _t(e, t, n, r) {
			...
			I.setRenderTarget(s), I.getClearColor(pe), me = I.getClearAlpha(), me < 1 && I.setClearColor(16777215, .5), I.clear(), ke && Je.render(n);
			let p = I.toneMapping;
			I.toneMapping = 0;
			let m = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), N.setupLightsView(r), Ce === !0 && Ke.setGlobalState(I.clippingPlanes, r), vt(e, n, r), X.updateMultisampleRenderTarget(s), X.updateRenderTargetMipmap(s), Fe.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
			...
			I.setRenderTarget(l, d, f), I.setClearColor(pe, me), m !== void 0 && (r.viewport = m), I.toneMapping = p;
		}
		function vt(e, t, n) {
		...
		function bt(e, t, n) {
			...
			} else s.uniforms = He.getUniforms(e), z !== null && e.isNodeMaterial && z.build(e, n, s), e.onBeforeCompile(s, I), d = He.acquireProgram(s, c), l.set(c, d), r.uniforms = s.uniforms;
			let f = r.uniforms;
		...
		function wt(e, t, n, r, i) {
			...
			let a = t.fog, o = r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial ? t.environment : null, s = H === null ? I.outputColorSpace : H.isXRRenderTarget === !0 ? H.texture.colorSpace : K.workingColorSpace, c = r.isMeshStandardMaterial || r.isMeshLambertMaterial && !r.envMap || r.isMeshPhongMaterial && !r.envMap, l = Re.get(r.envMap || o, c), u = r.vertexColors === !0 && !!n.attributes.color && n.attributes.color.itemSize === 4, d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0), f = !!n.morphAttributes.position, p = !!n.morphAttributes.normal, m = !!n.morphAttributes.color, h = 0;
			r.toneMapped && (H === null || H.isXRRenderTarget === !0) && (h = I.toneMapping);
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Ye.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(q, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = ys()), C) {
				if (T.setValue(q, "toneMappingExposure", I.toneMappingExposure), v.needsLights && Tt(E, w), a && r.fog === !0 && Ue.refreshFogUniforms(E, a), Ue.refreshMaterialUniforms(E, r, ge, G, N.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				Za.upload(q, xt(v), E, X);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Za.upload(q, xt(v), E, X), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(q, "center", i.center), T.setValue(q, "modelViewMatrix", i.modelViewMatrix), T.setValue(q, "normalMatrix", i.normalMatrix), T.setValue(q, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.getActiveCubeFace = function() {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					J.bindFramebuffer(q.FRAMEBUFFER, o.__webglFramebuffer), de.copy(e.viewport), fe.copy(e.scissor), U = e.scissorTest, J.viewport(de), J.scissor(fe), J.setScissorTest(U), le = -1;
					return;
				}
				...
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && X.useMultisampledRTT(e) === !1 ? Y.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, de.copy(e.viewport), fe.copy(e.scissor), U = e.scissorTest;
			} else de.copy(ye).multiplyScalar(ge).floor(), fe.copy(be).multiplyScalar(ge).floor(), U = xe;
			if (n !== 0 && (r = B), J.bindFramebuffer(q.FRAMEBUFFER, r) && J.drawBuffers(e, r), J.viewport(de), J.scissor(fe), J.setScissorTest(U), i) {
		...
		this.readRenderTargetPixels = function(e, t, n, r, i, a, o, s = 0) {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				...
				try {
					...
					let e = H === null ? null : Y.get(H).__webglFramebuffer;
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
					...
					q.bindBuffer(q.PIXEL_PACK_BUFFER, f), q.bufferData(q.PIXEL_PACK_BUFFER, a.byteLength, q.STREAM_READ), q.readPixels(t, n, r, i, Qe.convert(l), Qe.convert(u), 0), q.bindBuffer(q.PIXEL_PACK_BUFFER, null);
					let p = H === null ? null : Y.get(H).__webglFramebuffer;
					J.bindFramebuffer(q.FRAMEBUFFER, p);
					let m = q.fenceSync(q.SYNC_GPU_COMMANDS_COMPLETE, 0);
					return q.flush(), await ae(q, m, 4), q.bindBuffer(q.PIXEL_PACK_BUFFER, f), q.getBufferSubData(q.PIXEL_PACK_BUFFER, 0, a), q.bindBuffer(q.PIXEL_PACK_BUFFER, null), q.deleteBuffer(f), q.deleteSync(m), a;
				}
			...
			if (e.isDepthTexture) {
				...
				J.bindFramebuffer(q.READ_FRAMEBUFFER, V), J.bindFramebuffer(q.DRAW_FRAMEBUFFER, oe);
			...
			se = 0, ce = 0, H = null, J.reset(), $e.reset();
